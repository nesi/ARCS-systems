...
do
   icp -rf -R arcs-df.ivec.org /ARCS/projects/IMOS/staging/ANFOG/PROCESSED/$dirName /ARCS/projects/IMOS/opendap/ANFOG
done
echo "complete copying to opendap"

for dirName in `ls /data/ARCS-DATA/ARCS/projects/IMOS/staging/ANFOG/RAW`
do
   icp -rf -R arcs-df.ivec.org /ARCS/projects/IMOS/staging/ANFOG/RAW/$dirName /ARCS/projects/IMOS/archive/ANFOG
done
echo "complete copying to archive"

for dirName in `ls /data/ARCS-DATA/ARCS/projects/IMOS/staging/ANFOG/JPEG`
do
   icp -rf -R arcs-df.ivec.org /ARCS/projects/IMOS/staging/ANFOG/JPEG/$dirName /ARCS/projects/IMOS/public/ANFOG
done
