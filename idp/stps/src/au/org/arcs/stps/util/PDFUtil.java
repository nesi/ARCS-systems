	...
	public OutputStream genPDF(String sourceIdP, String issuer,
		...
		try {
			...
			if (imageByteArray != null) {
				...
				logoTable.getDefaultCell().setBorder(com.lowagie.text.Rectangle.NO_BORDER);
			...
			attrTable.addCell(new Phrase(18, new Chunk("Issue Date", FontFactory
					.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD, new Color(
							0, 0, 0)))));
			...
			noteTable.getDefaultCell().setBorder(com.lowagie.text.Rectangle.NO_BORDER);
			...
			noteTable.addCell("");
			noteTable.addCell(note1);
			noteTable.addCell("");
			noteTable.addCell(note2);
