...
public class LdapUtil {
	...
	public Map<String, Set<String>> getUserAttributes(String userName) throws Exception {
	...
	private Map<String, Set<String>> search(String filter, String base, String[] attrs) {
		Map<String, Set<String>> attrMap = new HashMap<String, Set<String>>();
		try {
