...
import au.org.arcs.stps.action.SubmitAction;
 ...
 * 
 */
public class KeyDiscoveryImpl implements KeyDiscovery {
	private final Logger log = LoggerFactory
	.getLogger(KeyDiscoveryImpl.class);
	...
	public static void main(String[] args) {
		try {
			KeyDiscovery discovery = new KeyDiscoveryImpl();
