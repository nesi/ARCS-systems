...
Summary: The OpenSSH implementation of SSH protocol versions 1 and 2 with GSI Patch.
Name: gsi-openssh
Version: %{ver}
%if %{rescue}
Release: %{rel}rescue
...
Requires: gsi-openssh = %{version}-%{release}
Group: Applications/Internet
...
PreReq: gsi-openssh = %{version}-%{release}, chkconfig >= 0.9
%if ! %{build6x}
...
This version has been patched to include GSI authentication.
...
%changelog
* Thu Feb 21 2008 Florian Goessmann <florian@ivec.org>
- first release with GSI authentication patch
